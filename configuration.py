...
parser.add_argument('--etaA1',                 type=float,     default=-0.006,                help='eta_1 for activation')
parser.add_argument('--etaA2',                 type=float,     default=1.024,                 help='eta_2 for activation')
parser.add_argument('--etaA3',                 type=float,     default=0.016,                 help='eta_3 for activation')
parser.add_argument('--etaA4',                 type=float,     default=1.006,                 help='eta_4 for activation')
...
parser.add_argument('--etaN1',                 type=float,     default=0.290,                 help='eta_1 for negative weight')
parser.add_argument('--etaN2',                 type=float,     default=0.710,                 help='eta_2 for negative weight')
parser.add_argument('--etaN3',                 type=float,     default=-0.017,                help='eta_3 for negative weight')
parser.add_argument('--etaN4',                 type=float,     default=20.,                   help='eta_4 for negative weight')
