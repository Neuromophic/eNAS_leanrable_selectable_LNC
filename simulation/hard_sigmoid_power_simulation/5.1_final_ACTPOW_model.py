...
if os.path.exists(f'./NNs/final_ACTPOW_{exp_setup}'):
    pass
else:

    with open('./data/act_power_dataset.p', 'rb') as file:
        a = pickle.load(file)
    ...
    torch.save(model, f'./NNs/final_ACTPOW_{exp_setup}')
